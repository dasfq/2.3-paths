...
# 3. Берём первую группу и первых 500 друзей, проверяем методом group.isMember есть ли среди этих друзей состоящие в данной группе.
# 4. Если находим хоть одного друга в группе, то удаляем этот id группы из словаря.
# 5. Перебираем остальные группы
